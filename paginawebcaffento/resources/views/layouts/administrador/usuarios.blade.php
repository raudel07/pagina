                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-roud btnEditar" data-id="{{$usuario->id}}" data-name="{{$usuario->name}}" data-ap="{{$usuario->ap}}" data-am="{{$usuario->am}}" data-telefono="{{$usuario->telefono}}" data-email="{{$usuario->email}}" data-nivel="{{$usuario->nivel}}" data-toggle="modal" data-target="#modalEditar">
